...
## **计费项**
云联网目前唯一计费项是跨地域带宽包，每两个地域之间一个带宽包
...
### **服务质量**
地域之间报文传输的可靠性，支持钻石、铂金三种模式，报文传输质量可靠性依次减小，售价也依次降低
...
| 流量计费 | 后付费       | 元/月，最少购买时长为1天，默认限速**30M**，按实际使用流量进行计费；  | 适用于小带宽，临时使用的场景；   |

*流量计费模式在部分海外地域对间不支持，其中涉及伦敦，拉各斯，迪拜，孟买，曼谷，雅加达，圣保罗地域全部不支持，详细线路请咨询客户经理。*
...
例如：客户A，于8月5日上午10点半购买了从北京到上海30M的流量计费带宽，产品的单价为0.05分/M，今天北京出口流量为100.35M，上海的出口流量为50.2M，则客户A今天账单为：

今日使用流量为：100.35+50.2=150.55M，不足1M按1M处理，实际计费流量为151M；

今日账单为：151*0.05=7.55分；
