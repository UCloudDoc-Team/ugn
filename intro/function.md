...
云联网跨账号功能支持不同账号下的业务互通，覆盖企业多账号管理场景，支持跨地域复杂拓扑，支持用户更加灵活地处理跨团队合作业务。

### **带宽保障：多元业务，按需选择**

云联网产品为用户提供专线质量保障服务，同时支持：钻石（质量最优）、铂金（质量均衡）两种服务质量，**根据产品规划，黄金（成本敏感）级服务质量将于2026年3月11日 0 时起全面下线**，可根据业务灵活选择。

| **服务质量** | **说明**             | **适用场景**                           |
| :----------- | :------------------- | :------------------------------------- |
| 钻石         | 优先调度，优先转发； | 支付等网络质量要求较高的场景；         |
| 铂金         | 调度次之，转发次之； | 游戏等场景；                           |
| **黄金（即将下线）**        | 普通调度，尽力转发； | 上传、下载等对服务质量要求一般的场景； |
...
| **区域** | 可支持的可用区                                               |
| :------- | :----------------------------------------------------------- |
| **大陆** | 华北（北京2）（北京）、华北（乌兰察布）（乌兰察布）、上海、华南（广州）               |
| **境外** | 香港、新加坡、韩国（首尔）、日本（东京）、美国（洛杉矶）、台湾（台北）、俄罗斯（莫斯科）、德国（法兰克福）、泰国（曼谷）、菲律宾（马尼拉）、胡志明、英国（伦敦）、印度尼西亚（雅加达）、美国（华盛顿） |
