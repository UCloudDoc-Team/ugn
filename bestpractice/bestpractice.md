...
某企业用户在华南（广州）、香港、美国（洛杉矶）设有办公室，并将部分业务放置在优刻得云上，需要将此三个地域的云上业务打通，以便统一管理。下面介绍详细操作步骤：

### 开通前检查

1. 确认华南（广州）、香港、美国（洛杉矶）三个可用区已有VPC实例，在“项目一”分别为“VPC-GZ”、“VPC-HK”、“VPC-LA”
...
| ------------ | -------------------- | ------------------------------ |
| 项目         | 选择关联实例所属项目 | 项目一                         |
| 地域         | 选择关联实例所属地域 | 分别选择华南（广州）、香港、美国（洛杉矶）     |
...
在云联网实例管理界面点击【管理云联网】，选择并进入“带宽包”TAB页，点击【购买带宽包】，购买华南（广州）-香港、香港-美国（洛杉矶）、美国（洛杉矶）-香港互通带宽包。

| 配置项               | 说明                                                         | 配置                                                         |
| -------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| 带宽包名称           | 填写带宽包名称                                               | 自定义名称                                                   |
| 计费方式             | 选择带宽包计费方式，分为固定带宽预付费，和第五峰值后付费两种模式 | 按需选择付费类型                                             |
| 带宽包类型及互通地域 | 选择带宽包类型，根据带宽包类型可选对应地域                   | 分别选择跨境-华南（广州） ⇌香港、香港 ⇌美国（洛杉矶）                        |
| 带宽类型             | 选择带宽上下行限速方式和限速值                               | 按需填写限速方式和上限带宽值。目前除华南（广州）-香港外，其余线路限速方式均为对称限速，华南（广州）-香港非对称出口比例5:1 |
